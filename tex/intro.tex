...
\tunemarkup{pgkobomini}{\fontsize{17}{19.5}\selectfont}
...
\tunemarkuptwo{pgkindledx}{}{This PDF file also includes the interactive quiz (\totalcurqs\ questions in total) based on the material of the book and called \bibemph{The Cosmic Citizenship Quiz}.}
