...
\vsetspace
\vs p030 2:130 \pc\tunemarkup{pgauraone}{\kern-4pt}\tunemarkup{pgkoboaurahd}{\kern-4pt} \bibemph{COMPOSITE PERSONALITY GROUPS.} There are on Uversa the records of numerous additional groups of intelligent beings, beings that are also closely related to the organization and administration of the grand universe. Among such orders are the following three composite personality groups:
\vsetspace
