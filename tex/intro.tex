...
\begin{center}
\Large\tunemarkup{pgafour}{\huge}\tunemarkup{pgauraone}{\LARGE}\bfseries
INTRODUCTION
\end{center}
...
\tunemarkup{pgkoboaurahd}{\fontsize{14.5}{16.7}\selectfont}
\tunemarkup{pgauraone}{\fontsize{15}{18.5}\selectfont}
...
\begin{itemize}
\item The text is called \bibemph{The Revised Urantia Papers} and is based on the original Fifth Epochal Revelation revised according to my knowledge and experience.
...
and made it available on my website in both electronic and printed form:
