\newcommand{\nocopyright}{%
  {\fontsize{9}{9}\selectfont\textcopyright%
   \kern-2.1ex
  {\fontsize{18}{18}\selectfont\raisebox{-0.15ex}{\textmd{\texttimes}}}%
}%
}

\makeatletter
\bib@raise@anchor{\bibpdfbookmark[0]{Cover}{Cov}}%
\makeatother
...
\tunemarkup{pgkoboaurahd}{\fontsize{12}{20}\selectfont}
{\itshape OR}\\[1ex]
\tunemarkup{pgkindledx}{\fontsize{15}{32}\selectfont}
\tunemarkup{pghanlin}{\fontsize{10}{20}\selectfont}
\tunemarkup{pgnexus7}{\fontsize{11.2}{20}\selectfont}
\tunemarkup{pgkoboaurahd}{\fontsize{13}{20}\selectfont}
...
\itshape
The Standard Reference Text in British English,\\
with Metric Measures, Textual Variants,\\
Study Notes \&\ Illustrations\\
\tunemarkup{pgnexus7}{\textcolor{ubdarkred}{With Words of Jesus in Red Colour}\\}
\tunemarkup{pgkindledx}{\fontsize{14}{20}\selectfont}
\tunemarkup{pghanlin}{\fontsize{9}{18}\selectfont}
\tunemarkup{pgnexus7}{\fontsize{9}{18}\selectfont}
\tunemarkup{pgkoboaurahd}{\fontsize{13}{20}\selectfont}
...
%{
%\vspace*{\stretch{0.1}}
%\fontspec[Mapping=tex-text]{Coventry}\fontsize{24}{30}\selectfont
%%\fontspec[Mapping=tex-text]{URW Chancery L}\fontsize{14}{20}\selectfont
%\setlength{\fboxsep}{10pt}
%\doublebox{\parbox{10.8cm}{\centering To John F. Smith\\Put your gift message here.\\}}
%}
\vspace*{\stretch{0.3}}
...
Please send all comments \&\ suggestions to: {\makeatletter\upshape\bfseries Tigran~Aivazian~<tigran@bibles.org.uk>\makeatother}\\[1pt]
The latest version of this book can be downloaded from:\\[1ex]
