...
\end{quote}
\vsetspace
\vs p030 2:65 \ublistelem{V.}\bibnobreakspace \bibemph{PERSONALITIES OF THE INFINITE SPIRIT.}
\vsetspace
...
\end{quote}
\vsetspace
\vs p030 2:116 \kern4pt\ublistelem{VII.}\bibnobreakspace \bibemph{THE CORPS OF PERMANENT CITIZENSHIP.}
\begin{quote}
...
\vsetspace
\vs p030 2:130 \pc \bibemph{COMPOSITE PERSONALITY\tunemarkup{pghanlin}{\linebreak} GROUPS.} There are on Uversa the records of numerous additional groups of intelligent beings, beings that are also closely related to the organization and administration of the grand universe. Among such orders are the following three composite personality groups:
\vsetspace
