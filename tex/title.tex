...
%{
%\vspace*{\stretch{0.1}}
%\fontspec[Mapping=tex-text]{CoventryCyrillic}\fontsize{24}{30}\selectfont
...
Please send all comments \&\ suggestions to: {\makeatletter\upshape\bfseries Tigran~Aivazian~<aivazian.tigran@gmail.com>\makeatother}\\[1pt]
